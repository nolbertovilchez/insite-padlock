<div class="modal fade" id="md-manage-create-users">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal mrg-top-20" id="form-create-users">
                    <div class="form-group row">
                        <label for="form-1-1" class="col-md-3 control-label">Identificación</label>
                        <div class="col-md-9">
